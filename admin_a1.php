...
window.onload = function () {
   ...
   var chart = new CanvasJS.Chart("chartRealTime",
   {
      ...
      title:{
         ...
         fontColor: "#202020", // "#3a1B3C" "#0C090A" 
   ...
   $.getJSON("service_a1.php", function(data) {  
   ...
   var chart1 = new CanvasJS.Chart("chartMachineRuntime",
      ...
      $.getJSON("servicerunstop_a1.php", function(result) {  
      chart1.options.data[0].result.dataPoints = [];
      chart1.options.data[1].result.dataPoints = [];
      $.each((result), function(key, value){
         chart1.options.data[0].dataPoints.push({label: ['MOT A1'],  y: parseInt(value[0])});
         chart1.options.data[1].dataPoints.push({label: ['MOT A1'],  y: parseInt(value[1])});
