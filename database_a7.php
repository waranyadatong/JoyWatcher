...
<div class="panel panel-custom-horrible-purple">
    <div class="panel-heading">
        <h3 class="panel-title" style="font-size: 18px;"><center>Database of MOT A-A7</h3>
    </div>
        ...
        <table class="table table-bordered table-striped" id="tbl_exporttable_to_xls">
            ...
            <tbody>
                <?php                               
                    ...
                    $sqlAdmin = $db->query("SELECT Date_Time,Product_Name,Count,start_time,end_time FROM a7 WHERE Date_Time BETWEEN '$sdate $time' AND '$edate $time'");
                    $usetime = 0;
                    $F1 = TRUE;
...
<script>
    function downloadXlsx() {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Database_A7");
