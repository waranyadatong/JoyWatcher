...
<?php include_once('layouts/header.php');?>
   ...
   <form class="form-inline" action="#">
      ...
      <button  onclick="tablesToExcel( [{ 'sheet': 'Overview','tables' : ['tbl_exporttable_to_xls_1','tbl_exporttable_to_xls_2']}], 'Analytics_JoyWatcher_A6.xls', 'Excel')"class="button button2" class="form-control" name="excel"><span class="glyphicon glyphicon-floppy-save"></span> Export to Excel</button>
      <?php } ?>   
   </form>
   <br/>
   <?php
      ...
      if(isset($_GET['from_date']) && isset($_GET['to_date'])) {      
         ...
         $query = "SELECT count(*) AS total FROM a6 WHERE Date_Time BETWEEN '$from_date $Timeoutput' AND '$to_date $Timeoutput'";
         ...
         $querytime = "SELECT Date_time AS t FROM a6 WHERE Date_Time BETWEEN '$from_date $timestart' AND '$to_date $timestart'";
         ...
         $queryavg = "SELECT Takt_time as takttime,start_time as starttime,end_time as endtime FROM a6 WHERE Date_Time BETWEEN '$from_date $timeavg' AND '$to_date $timeavg'";
         ...
         $queryrunstop = "SELECT Takt_time as tk,start_time as st,end_time as et FROM a6 WHERE Date_Time BETWEEN '$from_date $timerunstop' AND '$to_date $timerunstop'";
         ...
         $query8 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 8 THEN 1 END) AS 'hour8' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time8' AND '$to_date $Time8'";
         ...
         $query9 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 9 THEN 1 END) AS 'hour9' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time9' AND '$to_date $Time9'";
         ...
         $query10 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 10 THEN 1 END) AS 'hour10' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time10' AND '$to_date $Time10'";
         ...
         $query11 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 11 THEN 1 END) AS 'hour11' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time11' AND '$to_date $Time11'";
         ...
         $query12 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 12 THEN 1 END) AS 'hour12' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time12' AND '$to_date $Time12'";
         ...
         $query13 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 13 THEN 1 END) AS 'hour13' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time13' AND '$to_date $Time13'";
         ...
         $query14 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 14 THEN 1 END) AS 'hour14' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time14' AND '$to_date $Time14'";
         ...
         $query15 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 15 THEN 1 END) AS 'hour15' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time15' AND '$to_date $Time15'";
         ...
         $query16 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 16 THEN 1 END) AS 'hour16' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time16' AND '$to_date $Time16'";
         ...
         $query17 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 17 THEN 1 END) AS 'hour17' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time17' AND '$to_date $Time17'";
         ...
         $query18 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 18 THEN 1 END) AS 'hour18' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time18' AND '$to_date $Time18'";
         ...
         $query19 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 19 THEN 1 END) AS 'hour19' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time19' AND '$to_date $Time19'";
         ...
         $query20 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 20 THEN 1 END) AS 'hour20' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time20' AND '$to_date $Time20'";
         ...
         $query21 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 21 THEN 1 END) AS 'hour21' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time21' AND '$to_date $Time21'";
         ...
         $query22 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 22 THEN 1 END) AS 'hour22' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time22' AND '$to_date $Time22'";
         ...
         $query23 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 23 THEN 1 END) AS 'hour23' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time23' AND '$to_date $Time23'";
         ...
         $query0 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 0 THEN 1 END) AS 'hour0' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time0' AND '$to_date $Time0'";
         ...
         $query1 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 1 THEN 1 END) AS 'hour1' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time1' AND '$to_date $Time1'";
         ...
         $query2 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 2 THEN 1 END) AS 'hour2' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time2' AND '$to_date $Time2'";
         ...
         $query3 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 3 THEN 1 END) AS 'hour3' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time3' AND '$to_date $Time3'";
         ...
         $query4 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 4 THEN 1 END) AS 'hour4' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time4' AND '$to_date $Time4'";
         ...
         $query5 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 5 THEN 1 END) AS 'hour5' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time5' AND '$to_date $Time5'";
         ...
         $query6 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 6 THEN 1 END) AS 'hour6' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time6' AND '$to_date $Time6'";
         ...
         $query7 = "SELECT COUNT(CASE WHEN HOUR(TIME(Date_Time))= 7 THEN 1 END) AS 'hour7' FROM a6 WHERE Date_Time BETWEEN '$from_date $Time7' AND '$to_date $Time7'";
         ...
         $dataPoints1 = array(
            array("y" => $pruntime, "label" => "MOT A6")
         );
         $dataPoints2 = array(
            array("y" => $pstoptime, "label" => "MOT A6")
         ); 
   }else{
         $dataP1 = 0;
         $dataP2 = 0;
         $dataPoints1 = array(
            array("y" => $dataP1, "label" => "MOT A6")
         );

         $dataPoints2 = array(
            array("y" => $dataP2, "label" => "MOT A6")
         );
                  ...
                  <h3 class="panel-title" style="margin-top: 4px; font-size: 19px; text-align: center;">Data Output of Joy Watcher
                     <form class="pull-right" action="" enctype="multipart/form-data">
                        <!--<button onclick="downloadImage1();" class="button button3" style="margin-top: -10px; margin-right: -5px; font-weight: normal;"><span class="glyphicon glyphicon-floppy-save"></span>Export File</button>-->
                            <a data-name="myChart" id="downloadavg" download="ChartOutput_A6.jpg" href="" class="download button button3"class="download glyphicon glyphicon-floppy-save"style="margin-top: -10px; margin-right: -5px; font-weight: normal;">Export File</a>
                     </form>
...
?>
   ...
   function downloadImage1() {
      ...
      link.download = 'ChartOutput_A6.jpg';
      link.click();
      myChart.options.title.text = 'Data Output of Joy Watcher';
      myChart.update({
         duration: 0
   ...
   var chart1 = new CanvasJS.Chart("chartMachineRuntime",
      ...
      $("#exportButton").click(function(){
         html2canvas(document.querySelector("#chartMachineRuntime")).then(canvas => { 
            ...
            downloadLink.setAttribute('download', 'MachineRuntime_A6.png');
