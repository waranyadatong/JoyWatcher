...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha784-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">
</head>
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-3">
          <div class="boxmachine">
            <div class="inner">
              <h3 style="font-size: 38px; text-align: center; font-weight: bold;">M/C: MOT-A7</h3>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    window.onload = function() {
      ...
      $.getJSON("process_data_a7.php", function(data) {
