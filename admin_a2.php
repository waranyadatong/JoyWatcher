...
<?php
   ...
   if (isset($_POST['rev']) && $_POST['rev'] == 1) {
      ...
      global $db;
      $output = 0;
      $query = "SELECT count(*) AS total FROM a2 WHERE Date_Time BETWEEN '$Start' AND '$End'";
      ...
      $timetotal = 0;
      $querytime = "SELECT Date_time AS t,Takt_time as tak FROM a2 WHERE Date_Time BETWEEN '$Start' AND '$End'";
      ...
      $queryavg = "SELECT Takt_time as takttime,start_time as starttime,end_time as endtime FROM a2 WHERE Date_Time BETWEEN '$Start' AND '$End'";
      ...
      $queryrunstop = "SELECT Takt_time as tk,start_time as st,end_time as et FROM a2 WHERE Date_Time BETWEEN '$Start' AND '$End'";
...
window.onload = function () {
   ...
   var chart = new CanvasJS.Chart("chartRealTime",
   {
      ...
      title:{
         ...
         fontColor: "#202020", // "#3a2B3C" "#0C090A" 
   ...
   $.getJSON("service_a2.php", function(data) {  
   ...
   var chart1 = new CanvasJS.Chart("chartMachineRuntime",
      ...
      $.getJSON("servicerunstop_a2.php", function(result) {  
      chart1.options.data[0].result.dataPoints = [];
      chart1.options.data[1].result.dataPoints = [];
      $.each((result), function(key, value){
         chart1.options.data[0].dataPoints.push({label: ['MOT A2'],  y: parseInt(value[0])});
         chart1.options.data[1].dataPoints.push({label: ['MOT A2'],  y: parseInt(value[1])});
