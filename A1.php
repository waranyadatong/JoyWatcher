...
<?php
  ...
  if (isset($_POST['rev']) && $_POST['rev'] == 1) {
    ...
    global $db;
    $output = 0;
    $query = "SELECT count(*) AS total FROM a1 WHERE Date_Time BETWEEN '$Start' AND '$End'";
    ...
    $productresult = "";
    $queryproduct = "SELECT Product_Name FROM a1 WHERE Date_Time BETWEEN '$Start' AND '$End'";
    ...
    $targettotal = 0;
    $hourtarget = 0;
    $querytarget = "SELECT target FROM target_a1 WHERE datetime BETWEEN '$Start' AND '$End'";
    ...
    $timetotal = 0;
    $querytime = "SELECT Date_time AS t,Takt_time as tak FROM a1 WHERE Date_Time BETWEEN '$Start' AND '$End'";
    ...
    $queryavg = "SELECT Takt_time as takttime,start_time as starttime,end_time as endtime FROM a1 WHERE Date_Time BETWEEN '$Start' AND '$End'";
    ...
    $queryrunstop = "SELECT Takt_time as tk,start_time as st,end_time as et FROM a1 WHERE Date_Time BETWEEN '$Start' AND '$End'";
...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha184-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">
</head>
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-3">
          <div class="boxmachine">
            <div class="inner">
              <h3 style="font-size: 38px; text-align: center; font-weight: bold;">M/C: MOT-A1</h3>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    window.onload = function() {
      ...
      $.getJSON("process_data_a1.php", function(data) {
