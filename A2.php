...
<?php
  ...
  if (isset($_POST['rev']) && $_POST['rev'] == 1) {
    ...
    $productresult = "";
    $queryproduct = "SELECT Product_Name FROM a2 WHERE Date_Time BETWEEN '$Start' AND '$End'";
    ...
    $targettotal = 0;
    $hourtarget = 0;
    $querytarget = "SELECT target FROM target_a2 WHERE datetime BETWEEN '$Start' AND '$End'";
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-lg-3">
          <div class="boxmachine">
            <div class="inner">
              <h3 style="font-size: 38px; text-align: center; font-weight: bold;">M/C: MOT-A2</h3>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    window.onload = function() {
      ...
      $.getJSON("process_data_a2.php", function(data) {
