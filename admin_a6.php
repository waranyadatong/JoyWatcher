...
window.onload = function () {
   ...
   var chart = new CanvasJS.Chart("chartRealTime",
   {
      ...
      title:{
         ...
         fontColor: "#202020", // "#3a6B3C" "#0C090A" 
   ...
   $.getJSON("service_a6.php", function(data) {  
   ...
   var chart1 = new CanvasJS.Chart("chartMachineRuntime",
      {
         ...
         data: [
         {
            ...
            dataPoints: []
               //{ y:'pruntime' , label: "MOT A6", indexLabel: "pruntime" }
...

         {
            ...
            yValueFormatString: "#,##0\"%\"",
            dataPoints: []
               //{ y: 'pstoptime' , label: "MOT A6", indexLabel: "pstoptime" }          
         }
         ]
      });

      $.getJSON("servicerunstop_a6.php", function(result) {  
      chart1.options.data[0].result.dataPoints = [];
      chart1.options.data[1].result.dataPoints = [];
      $.each((result), function(key, value){
         chart1.options.data[0].dataPoints.push({label: ['MOT A6'],  y: parseInt(value[0])});
         chart1.options.data[1].dataPoints.push({label: ['MOT A6'],  y: parseInt(value[1])});
